...
def make_choice(choice_type):
    ...
    story_snippet = f"You made the choice: {choice_type}. Your age is now {user.current_age}."
    
    return jsonify({'message': story_snippet, 'age': user.current_age, 'stage': user.current_stage})
